...
class BaiduRest:
    ...
    def getText(self, filename):
        ...
        r = requests.post(
            self.upvoice_url, data=bytes(post_data, encoding="utf-8"))
        # 3.处理返回数据
        return r.text
...
if __name__ == "__main__":
    ...
    # 将字符串语音合成并保存为out.mp3
    bdr.getVoice(
        "问题,作为开发人员,你的职责是什么,答按照工作进度和编程工作规范编写系统中的关键模块,设计编写详细设计,配合测试员修改相应的程序,提供软件的后期技术支持,进行编码实现,代码走查,单元测试,产品交付,",
        "out.mp3")
    # 识别test.wav语音内容并显示
